...
<template>
  <div
    ...
    style="height: 60px"
  >
    <button class="menu-text-color" @click="handleNavbarToggle">
      <inline-svg
        :src="icon_public_81"
        width="20"
        height="20"
    ...
    <button class="menu-text-color" @click="goHomePage">
      <inline-svg
        :src="icon_public_34"
        width="20"
        height="20"
    ...
    <!-- <button class="menu-text-color" @click="goToSharePage">
    ...
    <button class="menu-text-color" @click="handleSportsToggle">
      <inline-svg
        :src="icon_public_40"
        width="20"
        height="20"
    ...
    <button class="menu-text-color" @click="handleRewardToggle">
      <inline-svg
        :src="icon_public_100"
        width="20"
        height="20"
      ...
      >
        ...
        <template v-for="(mailItem, index) in tempMailList" :key="index">
          ...
          >
            ...
            <div class="ml-4" style="line-height: 18px">
