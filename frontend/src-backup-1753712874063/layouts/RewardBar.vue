...
<template>
  ...
  >
    <div :class="scrollTop == 0 ? 'm-reward-menu' : 'm-reward-menu-active-bg'" v-if="token">
      ...
      <div class="mx-4 my-1 align-center" v-if="token">
        <div cols="9" class="text-400-12 py-1 px-0 d-flex align-center">
          <input
        ...
        <div cols="3" class="pa-1 text-right">
          <button
    ...
    <div :class="token? 'm-reward-total-body' : 'm-reward-logout-total-body'" @scroll="handleScroll">
      <div class="m-reward-header" v-if="token">
        <div class="mx-4 my-2 m-reward-achievement-bonus">
          <div cols="3" class="d-flex align-center justify-center">
            <img
      ...
      <div class="m-reward-body mx-4 mb-4">
        ...
        <template v-for="(item, index) in bonus_items" :key="index">
          <div class="ma-0 m-reward-bonus-card" :class="index != 0 ? 'mt-2' : ''">
            <div cols="3" class="d-flex align-center justify-center py-1">
              <img :src="item.image" :width="index == 0 ? 34 : 38" />
            </div>
            <div cols="6" class="py-1 d-flex align-center">
              <div>
            ...
            <div cols="3" class="d-flex align-center py-1">
              <button
                :class="
