...
<template>
  ...
  >
    <div class="d-flex align-center" v-if="!navBarToggle && mobileWidth > 600">
    </div>

    <div v-if="mobileWidth > 800">
      <img
      ...
      <div class="d-flex align-center">
        <div>
          <div>
            ...
            >
              <div class="deposit-item user-card-height pr-1">
                <div class="d-flex align-center">
                  <div>
                    <div>
                      <div
                    ...
                    <div theme="dark" bg-color="#1D2027" class="px-2" width="427px">
                      <div
            ...
            <div
              ...
              v-else
            >
              <div class="deposit-item m-user-card-height px-2">
                <div class="d-flex align-center">
                  <div>
                    <div>
                      <div
        ...
        <div>
          ...
          <div theme="dark" bg-color="#1D2027" class="px-2" width="320">
            <div class="user-item" value="id">
              <div>
                <img src="@/assets/public/svg/icon_public_58.svg" />
              </div>
              <div class="ml-2"
                >{{ t("appBar.id") }}: {{ userInfo.uid }}</div
              >
              <div>
                <img
            ...
            <div class="user-item" value="deposit" @click="depositDialogShow">
              <div>
            ...
            <div class="user-item" value="bonuses" @click="goBonusPage">
              <div>
            ...
            <div class="user-item" value="withdraw" @click="withdrawDialogShow">
              <div>
            ...
            <div class="user-item app-background" value="app">
              <div>
            ...
            <div class="user-item" value="fairness">
              <div>
            ...
            <div class="user-item" value="rewards">
              <div>
            ...
            <div class="user-item" value="preferences">
              <div>
            ...
            <div class="user-item" value="statistics">
              <div>
        ...
        <div class="mail-menu">
          ...
          <div theme="dark" bg-color="#1D2027" class="px-2" width="400">
            <div
              class="mail-item"
