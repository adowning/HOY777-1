...
<template>
    <div temporary location="right" v-model="vipDrawer" :touchless="true" class="m-vip-drawer">
        <div class="vip-main" ref="vipNavigation">
            <div class="vip-main-header">
                <button class="m-vip-drawer-close-button" icon="true" width="20" height="20" @click="setVipNavBarToggle('0')">
                    <img :src="icon_public_10" width="18" />
                </button>
            </div>
            <div center-active dark v-model="vipTab">
                <div
