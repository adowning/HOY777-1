...
export namespace NETWORK_ROUTES {
  //Login Related News
  export class LOGIN {
  ...
  export class VIP_INFO {
    static USER_VIP_INFO = '/vip/vipinfo'; // vip info
    static USER_VIP_LEVEL = '/viplevels'; // vip levels
    static VIP_TASKS = '/vip/viptasks'; // vip tasks
    static VIP_LEVEL_AWARD = '/vip/viplevel/award' // vip level award
    static VIP_REBATE_AWARD = '/vip/viprebate/award' // vip rebate award
    static VIP_REBATE_HISTORY = '/vip/viprebatehistory' // get vip coding record
    static VIP_LEVEL_AWARD_HISTORY = '/vip/viplevelawardhistory' // Obtain VIP level reward record
    static VIP_TIMES_HISTORY = '/vip/viptimeshistory' // Get VIP weekly and monthly reward records
    static VIP_SIGNIN_REWARDS = '/vip/vipsignin/award'; // Receive VIP sign-in rewards
    // static VIP_SIGNIN = '/vip/vipsignin'; // Get VIP check-in content
    static VIP_SIGNIN = '/vip/signinaward/list';  // Get VIP check-in content  获取签到奖励
    static VIP_SIGNINAWARD_RECEIVE = '/vip/signinaward/receive';  // Get sign-in rewards  领取签到奖励
    static VIP_LEVELUP_LIST = '/vip/viplevelup/list'; // Get VIP upgrade reward information
    static VIP_LEVELUP_RECEIVE = '/vip/viplevelup/receive'; // Receive VIP upgrade rewards
    static USER_VIP_CYCLEAWARD_LIST = '/vip/cycleaward/list';  // Get periodic rewards  获取周期性奖励
    static USER_VIP_CYCLEAWARD_RECEIVE = '/vip/cycleaward/receive';  // Receive periodic rewards  领取周期性奖励
    static USER_VIP_LEVELAWARD_LIST = '/vip/levelaward/list';  // Get level-related rewards  获取等级相关奖励
    static USER_VIP_LEVELAWARD_RECEIVE = '/vip/levelaward/receive';  // Receive level-related rewards  领取等级相关奖励
    static USER_VIP_BETAWARD_LIST = '/vip/betaward/list';  // Get coding rebates  获取打码返利
    static USER_VIP_BETAWARD_RECEIVE = '/vip/betaward/receive';  // Get coding rebates  领取打码返利
  }
