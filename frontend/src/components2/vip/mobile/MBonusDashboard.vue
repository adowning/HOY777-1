  ...
  >
    ...
    <div class="m-nav-drawer-content1">
      <div class="m-recharge-bonus-body">
        <div class="m-recharge-bonus-description">
          <div cols="9" class="m-recharge-col">
          ...
          <div cols="3" class="m-recharge-col m-recharge-col-img">
            <img
        ...
        <div style="margin-top: 16px; height: 40px; align-items: center" class="d-flex">
          <div cols="6" class="m-recharge-col m-recharge-col-btn1">
            <button class="m-recharge-more-btn">
          ...
          <div cols="6" class="m-recharge-col m-recharge-col-btn2">
      ...
      <div class="m-recharge-bonus-body">
        <div class="m-deposit-bonus-description">
          <div cols="6" class="m-recharge-col">
          ...
          <div cols="6" class="m-recharge-col m-recharge-col-img">
