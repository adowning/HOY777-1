...
<template>
  <div class="m-vip-container mb-0">
    ...
    >
      ...
      >
        <Slide v-for="(item, index) in vipLevelGroups" :key="index">
          <div class="m-vip-carousel-body">
            ...
            <div class="flex flex-wrap -mx-2 full-height mx-2 mt-0">
              <div class="w-full px-2 text-center pt-1 px-0 w-3/12">
              ...
              <div class="w-full px-2 w-9/12">
                <div class="deposit-progress-bg">
                  ...
                  <div style="margin-top: 3px">
                    <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden deposit-progress" v-model="item.deposit_rate" height="19">
                    </div>
                  </div>
                </div>
                <div class="deposit-progress-bg mt-2">
                  ...
                  <div style="margin-top: 3px">
                    <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden wager-progress" v-model="item.bet_rate" height="19">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="mt-4" :class="vipSlideClass" ref="slideElement">
        <div class="flex items-center overflow-x-auto py-2 space-x-4 vipSlidePosition ? 'pt-8' : '' relative" v-model="selectedVIPTab" style="{ height: vipSlidePosition ? '88px' : 'unset' }">
          <div class="flex-shrink-0 cursor-pointer" v-for="(item, index) in vipTabs" key="index" value="item">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 selectedVIPTab == item ? 'white' : 'text-gray'" width="mobileWidth < 600 ? 110 : 150" click="handleSelectVIPTab(item)">
              {{ item }}
            </button>
          </div>
        </div>
        ...
        >
          ...
          >
            <div class="reward-body mx-2 pb-4 mt-4" :class="tabSelect ? 'mt-4' : 'mt-4'">
              ...
              <div class="flex flex-wrap -mx-2 mt-2 justify-center pb-2 mx-2">
                <div class="w-full px-2 d-flex justify-center pa-1 w-6/12 md:w-3/12 md:ml-3/12">
                  <div class="m-reward-card text-center">
                    ...
                    <div class="mt-2 mx-4">
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-dark m-button-dark" width="-webkit-fill-available" height="28px">
 ...
 ? 'button-bright'
 : 'button-dark'
" width="-webkit-fill-available" height="28px" click="submitVipLevelAward(1)">
                        {{ t("vip.receive_btn_text") }}
                      </button>
                    </div>
                    <div class="mt-2 text-400-9 white">
 ...
 ? 'button-bright'
 : 'button-dark'
" width="-webkit-fill-available" height="28px" click="submitVipLevelAward(2)">
                        {{ t("vip.receive_btn_text") }}
                      </button>
                    </div>
                    <div class="mt-2 text-400-9 white">
                ...
                <div class="w-full px-2 d-flex justify-center pa-1 w-6/12 md:w-3/12 md:ml-3/12">
                  <div class="m-reward-card text-center">
                    ...
                    <div class="mt-2 mx-4">
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-dark m-button-dark" width="-webkit-fill-available" height="28px" click="submitVipLevelAward(3)">
                        {{ t("vip.receive_btn_text") }}
                      </button>
                    </div>
                    <div class="mt-2 text-400-9 white">
          ...
          >
            ...
            >
              ...
              >
                ...
                <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-yellow ml-auto relative" height="49px" width="160px" click="vipRebateAward">
                  <img
              ...
              <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-4 mx-3" theme="dark" color="#15161C" style="border-radius: 8px">
                <div class="pa-2">
                  <div class="flex flex-wrap -mx-2 ma-0 pa-0 align-center">
                    <div class="w-full px-2 w-5/12">
                      <p class="text-500-12 white">
                        {{ t("vip.cashback_body.text_3") }}
                        {{ item.content }}
                      </p>
                    </div>
                    <div class="w-full px-2 d-flex w-7/12">
                  ...
                  <div class="flex flex-wrap -mx-2 pa-0 ma-0">
                    <div class="w-full px-2 pa-1 w-6/12 md:w-3/12 md:ml-3/12" v-for="(cashItemKey, index) in Object.keys(item?.bet_award_rate)" key="index">
                      <div class="bg-white shadow-lg rounded-lg overflow-hidden text-center pa-2 relative" theme="dark" color="#1D2027" height="90" style="border-radius: 4px">
                        <img
              ...
              <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-4 mx-3" theme="dark" color="#15161C" style="border-radius: 8px">
                <div class="pa-4">
                  <div class="flex flex-wrap -mx-2 pa-0 mx-0 align-center">
                    ...
                    <div class="w-full px-2 text-right md:w-4/12 md:ml-4/12">
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-yellow ml-auto relative" height="49px" width="-webkit-fill-available" click="goToTransactionPage">
      ...
      <!-- <div ref="spinElement">
        ...
        >
          ...
          >
            ...
            >
              <div class="flex flex-wrap -mx-2 mx-2 d-flex">
                <div class="w-full px-2 text-800-14 white">
                  {{ t("vip.super_spin_body.text_1") }}
                </div>
                <div class="w-full px-2 px-1">
                  <div class="bg-white shadow-lg rounded-lg overflow-hidden ml-auto d-flex align-center" theme="dark" color="#15161C" height="49">
                    <div class="flex flex-wrap -mx-2 align-center ma-0 pa-0">
                      <div class="w-full px-2 ma-0 pa-0 w-5/12">
                        <p class="text-600-12 white text-center px-4">
                          {{ t("vip.super_spin_body.text_2") }}
                        </p>
                      </div>
                      <div class="w-full px-2 ma-0 pa-0 w-2/12">
                        <p class="text-800-20 white">{{ item.free_spins_times }}</p>
                      </div>
                      <div class="w-full px-2 ma-0 pa-0 w-5/12">
                        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-yellow m-spin-now-btn" height="49px" width="-webkit-fill-available">
              ...
              >
                ...
                <div class="flex flex-wrap -mx-2 mt-4 justify-center align-center" ref="spinCardItem">
                  <div class="w-full px-2 text-center d-flex justify-center pa-1 w-6/12 md:w-3/12 md:ml-3/12 lg:w-2/12 lg:ml-2/12" v-for="(item, index) in spinItems" key="index">
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6" theme="dark" color="#1D2027" style="border-radius: 6px">
                      <img :src="item.image" />
              ...
              <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-1C1929 m-spin-more-btn-position" width="140px" height="40px" style="transform: translateX(-50%) !important" click="spinCardShow = !spinCardShow">
                {{ t("vip.super_spin_body.text_5") }}
                <span class="inline-flex items-center justify-center mdi-down-position" v-if="!spinCardShow">mdi-chevron-down</v-icon
                >
                <span class="inline-flex items-center justify-center mdi-down-position" v-else>mdi-chevron-up</span>
              </button>
            </div>
          </SwiperSlide>
        </Swiper>
            ...
            >
              ...
              >
                <div class="flex flex-wrap -mx-2 justify-center align-center" ref="missionCardItem">
                  <div class="w-full px-2 text-center d-flex justify-center pa-1 w-6/12" v-for="(item, index) in vipMissionItems" key="index">
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6" theme="dark" color="#1D2027" v-if="item.type == 1" height="220" style="width: 100%; border-radius: 6px">
                      ...
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-bright m-mission-btn-1 mt-13 mx-2" height="28px" width="-webkit-fill-available">
                        {{ t("vip.vip_mission_body.text_6") }}
                      </button>
                    </div>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6" theme="dark" color="#1D2027" height="220" style="width: 100%; border-radius: 6px" v-if="item.type == 2">
                      <div
                      ...
                      <div class="mission-progress-bg mx-4 mt-6">
                        <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden mission-progress" v-model="item.missionRate" height="10">
                          <div class="text-500-10 white">
                            {{ item.currentRate }} / {{ item.totalRate }}
                          </div>
                        </div>
                      </div>
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-purple m-mission-btn-2 mt-4 mx-2" height="28px" width="-webkit-fill-available">
                        {{ t("vip.vip_mission_body.text_11") }}
                      </button>
                    </div>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6 mission-card-bg-3" theme="dark" height="220" style="width: 100%; border-radius: 6px" v-if="item.type == 3">
                      <div
                        class="m-mission-ongoing-position text-600-8 white align-center d-flex justify-center"
                      >
                        {{ t("vip.vip_mission_body.text_7") }}
                      ...
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-bright m-mission-btn-1 mt-3 mx-2" height="28px" width="-webkit-fill-available">
                        <img
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6" theme="dark" color="#1D2027" height="220" style="width: 100%; border-radius: 6px" v-if="item.type == 4">
                      <div
                      ...
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-dark m-mission-btn-3 mt-3 mx-2" height="28px" width="-webkit-fill-available">
                        {{ t("vip.vip_mission_body.text_2") }}
                      </button>
                    </div>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden py-6" theme="dark" color="#1D2027" height="220" style="width: 100%; border-radius: 6px" v-if="item.type == 5">
                      ...
                      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-dark m-mission-btn-3 mt-8 mx-2" height="28px" width="-webkit-fill-available">
                        <img
              ...
              <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-1C1929 m-spin-more-btn-position" width="140px" height="40px" style="transform: translateX(-50%) !important; border: 1px solid #923d71" click="missionCardShow = !missionCardShow">
                {{ t("vip.super_spin_body.text_5") }}
                <span class="inline-flex items-center justify-center mdi-down-position" v-if="!missionCardShow">mdi-chevron-down</v-icon
                >
                <span class="inline-flex items-center justify-center mdi-down-position" v-else>mdi-chevron-up</span>
              </button>
            </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="flex flex-wrap -mx-2 mt-2 mx-1">
              <div class="w-full px-2 ma-0 pa-1 w-6/12">
                <p class="text-700-12 white ml-2">
                  {{ t("vip.benifit_description_body.text_2") }}
                </p>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C" height="140" style="border-radius: 8px">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0">
                    <div class="w-full px-2">
              ...
              <div class="w-full px-2 ma-0 pa-1 w-6/12">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C" height="140" style="border-radius: 8px">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0 align-center">
                    <div class="w-full px-2">
                      <p class="text-500-12 text-gray">
                        {{ t("vip.benifit_description_body.text_5") }}
                      </p>
            ...
            <div class="flex flex-wrap -mx-2 mt-3 mx-0">
              <div class="w-full px-2 ma-0 pa-2">
                <p class="text-700-12 white ml-2">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0 align-center justify-center">
            ...
            <div class="flex flex-wrap -mx-2 mt-2 mx-0">
              <div class="w-full px-2 ma-0 pa-2">
                <p class="text-700-12 white ml-2">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0 align-center justify-center">
                    ...
                    <div class="w-full px-2 d-flex justify-start w-6/12">
                      <div>
                        <p class="text-500-12 text-gray">
              ...
              <div class="w-full px-2">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0 align-center justify-center">
                    ...
                    <div class="w-full px-2 d-flex justify-center w-5/12">
                      <div>
                        <p class="text-500-12 text-gray">
            ...
            <div class="flex flex-wrap -mx-2 my-2 mx-0">
              <div class="w-full px-2 ma-0 pa-2">
                <p class="text-700-12 white ml-2">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden mt-2" theme="dark" color="#15161C">
                  <div class="flex flex-wrap -mx-2 mx-2 my-0 pa-0 align-center justify-center">
                    <div class="w-full px-2 py-1 w-6/12">
                      <div class="benifit-description-border">
                        <p class="text-500-12 text-gray">
                    ...
                    <div class="w-full px-2 d-flex justify-start py-1 w-6/12">
                      <div>
                        <p class="text-500-12 text-gray">
      ...
      <div class="m-vip-footer-body relative mt-6 mx-2">
        <div class="flex flex-wrap -mx-2 ma-0 pa-0 align-center justify-center">
          ...
          <div class="w-full px-2 md:w-3/12 md:ml-3/12">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none button-yellow m-vip-footer-btn" width="-webkit-fill-available" height="49px">
