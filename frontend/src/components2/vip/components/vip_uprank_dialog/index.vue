    ...
    >
        <div class="vip-overlay">
            <div class="vip-overlay-header">
                ...
                <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 vip-overlay-header-close" icon="true" width="20" height="20" click="vipRankOverlay = false">
            ...
            <div class="vip-overlay-button">
                <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 bg-green-600 text-white hover:bg-green-700 focus:ring-green-500" click="dispatchVipLevelAwardReceive({ type: 6 })">
