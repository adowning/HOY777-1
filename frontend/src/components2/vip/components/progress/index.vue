            ...
            <div class="progress-main-card-m">
                ...
                <div class="progress-main-card-m-info">
                    ...
                    <div class="progress-main-card-m-info-rate">
                        <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden progress-main-card-m-info-rate-color" v-model="depositRate" height="16">
                        </div>
                    </div>
                </div>
            </div>
            <div class="progress-main-card-b">
                ...
                <div class="progress-main-card-b-info">
                    ...
                    <div class="progress-main-card-b-info-rate">
                        <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden progress-main-card-b-info-rate-color" v-model="betRate" height="16">
                        </div>
                    </div>
                </div>
            </div>
