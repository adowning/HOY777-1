  ...
  <div class="m-refferal-container">
    ...
    >
      <template v-if="descriptionVisible">
        ...
        <div class="mt-4 mx-6">
          <div class="bg-white shadow-lg rounded-lg overflow-hidden overflow-y-auto description-card" height="292" theme="dark" color="#15161C" style="scroll-padding: 20px">
        ...
        <div class="mt-6 mx-6">
          <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-dark m-reffer-btn-font text-none" width="-webkit-fill-available" height="46px" click="showMainDialog">
      ...
      <template v-else>
        ...
        >
          ...
          <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-close-button" icon="true" click="closeReferDialog" width="30" height="30">
        ...
        <div class="refferal-dialog-body">
          ...
          <div class="text-center mt-6 mx-6">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden" theme="dark" color="#15161C" height="40">
          ...
          <div class="text-center mt-8 mx-6">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright m-reffer-btn-font text-none" width="-webkit-fill-available" height="48px" click="copyToClipboard(inviteItem.web_invite_url)">
