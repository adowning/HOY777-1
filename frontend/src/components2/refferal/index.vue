    ...
    <div class="refferal-container">
        <template v-if="descriptionVisible">
            ...
            <div class="mt-6 mx-10">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden overflow-y-auto" height="420" theme="dark" color="#1D2027">
            ...
            <div class="mt-8 mx-12">
                <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-dark text-none" width="-webkit-fill-available" height="60px" click="showMainDialog">
        ...
        <template v-else>
            ...
            <div class="refferal-dialog-body">
                ...
                <div class="text-center mt-6 mx-12">
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden" theme="dark" color="#1D2027" height="48">
                        <div class="text-400-14 text-gray mt-4">{{ siteUrl }}</div>
                    </div>
                </div>
                <div class="text-center mt-10 mx-12">
                    <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none" width="-webkit-fill-available" height="60px" click="copyToClipboard">
                        {{ t('refferal.dialog.body.copy_btn_text') }}
                    </button>
                </div>
            </div>
        </template>
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 close-button" icon="true" click="setRefferalDialogShow(false)">
