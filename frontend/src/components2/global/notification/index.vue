...
<template>
    <v-snackbar v-model="snackbar" multi-line color="#181522" class="snack-bar" timeout="3000"
        ...
        <template v-slot:actions>
            ...
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 snackbar-close-button mt-3 mr-2" variant="text" click="snackbar = false">
    ...
    <v-snackbar v-model="snackbar" multi-line color="#181522" class="m-snack-bar" timeout="3000" v-else>
        <template v-slot:actions>
            ...
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-snackbar-close-button mt-2 mr-1" variant="text" click="snackbar = false">
