...
<template>
  <div class="m-confirm-dialog-container">
    ...
    <div class="mt-5 mx-4">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright m-confirm-btn" width="-webkit-fill-available" height="48" click="emit('submitConfirm')">
        {{ t("confirm.text_2") }}
      </button>
    </div>
  </div>
