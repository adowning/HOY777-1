...
<template>
    <div class="login-bonus-dialog-container">
        ...
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 close-login-bonus-button" icon="true" click="emit('closeLoginBonusDialog')" height="32" width="32">
        ...
        <div class="login-bonus-body">
            ...
            <div class="flex flex-wrap -mx-2 mt-4 mx-2">
            ...
            <div class="flex flex-wrap -mx-2 mt-6 mx-2">
                <div class="w-full px-2 pa-0 d-flex justify-center w-4/12">
            ...
            <div class="flex flex-wrap -mx-2 mt-8 mx-1 align-center">
                <div class="w-full px-2 pa-0 ma-0 w-2/12">
                    <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 left-login-bonus-button" icon="true" height="30" width="30">
