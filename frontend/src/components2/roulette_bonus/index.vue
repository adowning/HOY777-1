...
<template>
  <div class="roulette-bonus-dialog-container">
    <div class="roulette-bonus-dialog-header-left">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 roulette-bonus-dialog-sound-bg-1 ml-4" icon="true" width="34" height="34">
    ...
    <div class="roulette-bonus-dialog-header-right">
      <v-menu offset="14" content-class="roulette-bonus-help-menu" :scrim="false">
        <template v-slot:activator="{ props }">
          <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 roulette-bonus-dialog-help-bg mr-4" v-bind="props" icon="true" width="34" height="34">
        ...
        <ul class="bg-white rounded-md p-2 shadow" theme="dark" bg-color="#1D2027" width="439" height="596">
      ...
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 roulette-bonus-dialog-close-bg mr-4" icon="true" width="34" height="34" click="emit('closeRouletteBonusDialog')">
    ...
    <div class="roulette-bonus-dialog-body">
      ...
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none roulette-bonus-dialog-body-2" width="423" height="48" click="startRoulette" disabled="isSpinning || spinNumber <= 0">
      ...
      <div class="roulette-bonus-dialog-body-3">
        <div class="my-1">
          <div class="flex flex-wrap -mx-2 ma-0 mx-4 pa-0" v-for="(item, index) in rouletteHistory" key="index">
            <div class="w-full px-2 pa-1 ma-0 text-500-10 gray w-5/12">{{
              item.rouletteTime
            }}</div>
            <div class="w-full px-2 pa-1 ma-0 text-500-10 gray w-4/12">{{ item.user }}</div>
            <div class="w-full px-2 pa-1 ma-0 text-500-10 yellow w-3/12" v-if="item.rouletteResult == 'IPHONE 14'">{{ item.rouletteResult }}</v-col
            >
      ...
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 text-none roulette-bonus-dialog-body-4" width="170" height="36" click="showWinnerBody">
    ...
    >
      ...
      <div class="roulette-bonus-dialog-winner-content">
        <div class="my-2" v-if="!winnerToggleSwitch">
          <div class="flex flex-wrap -mx-2 ma-0 mx-4 pa-0" v-for="(winnerItem, winnerIndex) in rouletteWinnerHistory" key="winnerIndex">
            <div class="w-full px-2 pa-1 ma-0 text-500-10 gray w-5/12">{{
        ...
        <div class="my-2" v-else>
          <div class="flex flex-wrap -mx-2 ma-0 mx-4 pa-0" v-for="(prizeItem, prizeIndex) in roulettePrizeHistory" key="prizeIndex">
            <div class="w-full px-2 pa-1 ma-0 text-500-10 gray w-5/12">{{
