...
<template>
  <div class="flex flex-wrap -mx-2 mx-4 mt-2 mb-1 align-center">
    <div class="w-full px-2 ma-0 pa-0 md:w-5/12 md:ml-5/12 lg:w-5/12 lg:ml-5/12" style="height: 100%">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden text-center" color="#1D2027" theme="dark">
        ...
        <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer m-invite-url-item" v-for="(item, index) in inviteList" key="index" style="{
          ...
          <template v-slot:append>
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-invite-url-copy-btn" icon click="inviteUrlCopy(item.content)" bg-color="#23262F" width="24" height="24">
