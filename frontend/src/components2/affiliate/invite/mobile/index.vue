...
<template>
  ...
  <div class="flex flex-wrap -mx-2 justify-center mt-6 text-800-14 white">
    ...
    <div class="flex flex-wrap -mx-2">
      <div class="w-full px-2 md:w-4/12 md:ml-4/12 lg:w-4/12 lg:ml-4/12">
        <div class="flex flex-wrap -mx-2 align-center">
          ...
          <div class="w-full px-2 pt-0 text-right w-7/12">
      ...
      <div class="w-full px-2 md:w-4/12 md:ml-4/12 lg:w-4/12 lg:ml-4/12">
        <div class="flex flex-wrap -mx-2 align-center">
          ...
          <div class="w-full px-2 text-right pt-0 w-7/12">
            <div class="text-700-14 white">
      ...
      <div class="w-full px-2 text-center md:w-4/12 md:ml-4/12 lg:w-4/12 lg:ml-4/12">
  ...
  <div class="flex flex-wrap -mx-2 mt-6 justify-center mx-16">
