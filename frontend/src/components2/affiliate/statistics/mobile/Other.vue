...
<template>
  <div class="flex flex-wrap -mx-2 mt-4 m-statistics-profit-text justify-center">
    {{ t("affiliate.statistics.mobile_profit_title") }}
  </div>
  <div class="bg-white shadow-lg rounded-lg overflow-hidden m-statistics-profit-card-body">
    <div class="flex flex-wrap -mx-2 justify-center">
      <div class="w-full px-2 text-center mt-4">
        <div class="flex flex-wrap -mx-2 justify-center align-center">
          ...
          <div class="w-full px-2 py-0">
            ...
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none m-statistics-receive-btn" width="190" height="48">
              {{ t("affiliate.statistics.receive_btn_text") }}
            </button>
          </div>
        </div>
      </div>
      <div class="w-full px-2 text-center pt-0 justify-center">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden ma-4 text-center m-statistics-card-border" theme="dark" color="#15161C">
  ...
  <v-window v-model="profitTab">
    <v-window-item value="today">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden m-statistics-profit-card-today">
        <div class="flex flex-wrap -mx-2 justify-center">
          <div class="w-full px-2 text-center mt-4 px-6 pb-0">
            <div class="flex flex-wrap -mx-2 justify-center align-center">
              <div class="w-full px-2 w-6/12">
                <img src="@/assets/public/image/img_public_16.png" width="119" />
              </div>
              <div class="w-full px-2 text-center w-6/12">
          ...
          <div class="w-full px-2 text-center pt-0">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden ma-4 text-center m-statistics-card-border" theme="dark" color="#15161C">
              <p class="m-statistics-profit-cash-text-1" style="margin-top: 11px">
    ...
    <v-window-item value="week">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden m-statistics-profit-card-week">
        <div class="flex flex-wrap -mx-2 justify-center">
          <div class="w-full px-2 text-center mt-4 px-6 pb-0">
            <div class="flex flex-wrap -mx-2 justify-center align-center">
              <div class="w-full px-2 w-6/12">
    ...
    <v-window-item value="month">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden m-statistics-profit-card-month">
        <div class="flex flex-wrap -mx-2 justify-center">
          <div class="w-full px-2 text-center mt-4 px-6 pb-0">
            <div class="flex flex-wrap -mx-2 justify-center align-center">
              <div class="w-full px-2 w-6/12">
