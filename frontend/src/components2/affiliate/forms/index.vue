...
<template>
  <div class="mt-6 justify-end mx-6">
    <div offset="10" class="bonus-menu">
      <div @click="bonusMenuShow = !bonusMenuShow">
      ...
      <ul v-if="bonusMenuShow" theme="dark" bg-color="#1D2027">
        <li
    ...
    <div offset="10" class="bonus-menu">
      <div @click="cashMenuShow = !cashMenuShow">
        <div color="#15161C" theme="dark" class="ml-2">
          <div
            class="bonus-item"
      ...
      <ul v-if="cashMenuShow" theme="dark" bg-color="#1D2027">
        <li
  ...
  <div class="mx-4 mt-6">
    <table class="forms-bonus-table-bg" theme="dark" fixed-header>
  ...
  <div class="mt-6 justify-end mx-4">
    <Pagination :length="2" />
  </div>
</template>
<style lang="scss">
