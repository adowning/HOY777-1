...
<template>
  <div
    ...
    :key="index"
  >
    <div class="mx-0 align-center my-0" style="height: 100%">
      <div cols="1" class="text-center pa-0" style="height: 100%">
      ...
      <div cols="2" class="pa-0 text-right">
        <p
          class="text-900-18"
      ...
      <div cols="2" class="text-center pa-0">
        <button
          class="text-none"
          width="132"
          height="48"
