...
<template>
    <div class="m-user-container">
        ...
        <div class="relative ma-2" style="margin-top: 110px !important;">
            <input :label="t('account.item.nick_name_text')" class="form-textfield dark-textfield m-account-nickname-edit" variant="solo"
        ...
        <div style="margin-top: 70px !important" class="ma-2">
            <button class="ma-3 mt-8 button-bright m-account-dialog-save-btn" width="-webkit-fill-available" height="48"
