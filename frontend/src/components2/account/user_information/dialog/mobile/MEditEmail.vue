...
<template>
    <div class="m-user-container">
        ...
        <div class="mt-6 relative" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.item.email_text')" class="form-textfield dark-textfield m-account-email-edit-address" variant="solo"
                density="comfortable" v-model="email" />
        </div>
        <div class="relative" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.password.current_text')" class="form-textfield dark-textfield m-account-email-edit-password" variant="solo"
        ...
        <div class="mt-6" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <button class="ma-3 mt-8 button-bright m-account-dialog-save-btn" width="-webkit-fill-available" :loading="loading"
