...
const emit = defineEmits<{ (): void, (): void }>()
...
<template>
    <div class="m-user-container">
        ...
        <div class="mt-4 relative" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <input :label="t('account.password.current_text')" class="form-textfield dark-textfield m-account-password-edit-current" variant="solo"
        ...
        <div class="mt-4 relative" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <input :label="t('account.password.new_text')" class="form-textfield dark-textfield m-account-password-edit-new" variant="solo"
        ...
        <div class="mt-4 relative" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <input :label="t('account.password.repeat_text')" class="form-textfield dark-textfield m-account-password-edit-repeat" variant="solo"
        ...
        <div class="mt-4" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <button class="ma-3 mt-8 button-bright text-none m-account-dialog-save-btn" width="-webkit-fill-available"
                :loading="loading" height="48" :disabled="!validatePassword()" @click="submitPassword">
                {{ t('account.save_text') }}
            </button>
        </div>
        <button class="m-account-dialog-close-btn" icon="true" @click="emit('userDialogHide')" width="30" height="30">
