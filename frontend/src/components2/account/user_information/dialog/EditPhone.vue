...
<template>
    <div class="user-container">
        ...
        <div class="mt-10 relative" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.item.phone_text')" class="form-textfield dark-textfield" variant="solo"
        ...
        <div class="mt-10" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
