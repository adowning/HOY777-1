...
<template>
    <div class="user-container">
        ...
        <div class="mt-6 relative" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.item.email_text')" class="form-textfield dark-textfield" variant="solo"
        ...
        <div class="login-mail-card edit-mail" :style="{ height: mailCardHeight + 'px' }">
          <ul theme="dark" bg-color="#1D2027">
            <li
              class="text-500-16 white"
              value="gmail"
              @click="mergeEmail('@gmail.com')"
              >{{ emailPartName }}@gmail.com</li>
            <li
              class="text-500-16 white"
              value="hotmail"
              @click="mergeEmail('@hotmail.com')"
              >{{ emailPartName }}@hotmail.com</li>
            <li
              class="text-500-16 white"
              value="yahoo"
              @click="mergeEmail('@yahoo.com')"
              >{{ emailPartName }}@yahoo.com</li>
            <li
              class="text-500-16 white"
              value="icloud"
              @click="mergeEmail('@icloud.com')"
              >{{ emailPartName }}@icloud.com</li>
            <li
              class="text-500-16 white"
              value="outlook"
              @click="mergeEmail('@outlook.com')"
              >{{ emailPartName }}@outlook.com</li>
          </ul>
        </div>
        <div class="relative" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.password.current_text')" class="form-textfield dark-textfield" variant="solo"
        ...
        <div class="mt-6" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <button class="ma-3 mt-8 button-bright text-none" width="-webkit-fill-available" :loading="loading"
