...
<template>
    <div class="user-container">
        ...
        <div class="relative mt-10" :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'">
            <input :label="t('account.item.nick_name_text')" class="form-textfield dark-textfield" variant="solo"
        ...
        <div :class="mobileWidth < 600 ? 'ma-2' : 'ma-10'" class="mt-10">
            <button class="ma-3 mt-8 button-bright text-none" width="-webkit-fill-available"
