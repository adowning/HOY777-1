...
<template>
    <div class="user-container">
        ...
        <div class="mt-4 relative" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <input :label="t('account.password.new_text')" class="form-textfield dark-textfield" variant="solo"
        ...
        <div class="mt-4 relative" :class="mobileWidth < 600 ? 'mx-2' : 'mx-10'">
            <input :label="t('account.password.repeat_text')" class="form-textfield dark-textfield" variant="solo"
