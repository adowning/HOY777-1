...
<template>
  ...
  <div class="flex flex-wrap -mx-2 m-bonus-transaction-table-5">
    <div class="w-full px-2 d-flex w-6/12" style="margin-left: -12px; margin-top: 4px">
      <v-menu
        offset="20"
      ...
      >
        <template v-slot:activator="{ props }">
          <div class="bg-white shadow-lg rounded-lg overflow-hidden m-transaction-vip-menu-card" color="#15161C" theme="dark">
            <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer bonus-item text-700-12 px-2" v-bind="props" title="selectedVipMenuItem" append-icon="
                transactionVIPMenuShow ? 'mdi-chevron-down' : 'mdi-chevron-up'
              " style="min-height: 32px !important">
            </li>
          </div>
        </template>
        <ul class="bg-white rounded-md p-2 shadow" theme="dark" bg-color="#1D2027" width="167" style="border-radius: 8px">
 ...
 : 'gray'
" v-for="(item, i) in transactionVipMenuList" key="i" value="item" click="handleTransactionMenuDropdown(item)" style="min-height: 36px !important">
            <v-list-item-title class="text-400-12">{{ item }}</v-list-item-title>
          </li>
          <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer mx-2 m-transaction-vip-menu-last py-0" style="min-height: 25px !important">
            <img src="@/assets/public/svg/icon_public_50.svg" />
          </li>
        </ul>
      </v-menu>
    </div>
    <div class="w-full px-2 d-flex w-6/12" style="padding-right: 6px">
      <div style="width: 100%">
        <Pagination
