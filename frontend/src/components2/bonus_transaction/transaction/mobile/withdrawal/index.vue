...
<template>
        ...
        <template v-else>
          ...
          >
            ...
            <td
              ...
              style="padding-top: 21px !important; padding-bottom: 21px !important"
            >
              <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ma-2 button-bright text-none withdraw-refund-btn rounded-full" v-if="item.status == 0 || item.status == 1" loading="index == loadingIndex ? loading : false" click="refundWithdrawalSubmit(item.id, index)">
  ...
  <div class="flex flex-wrap -mx-2 m-bonus-transaction-table3">
    <div class="w-full px-2 d-flex w-4/12" style="margin-left: -12px; margin-top: 4px">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-withdraw-info-icon" icon width="24" height="24">
        <span class="inline-flex items-center justify-center">
          <img src="@/assets/public/svg/icon_public_53.svg" />
        </span>
      </button>
    </div>
    <div class="w-full px-2 d-flex w-8/12" style="padding-right: 6px">
      <div style="width: 100%">
        <Pagination
