...
<template>
      ...
      <tbody class="forms-table-body">
        <tr v-for="(item, index) in formsList" :key="index">
          ...
          <td class="text-400-16">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ma-2 button-bright text-none withdraw-refund-btn rounded-full" v-if="item.actionType == 1">
  ...
  <div class="flex flex-wrap -mx-2 ma-4 mx-2">
    <div class="w-full px-2 d-flex w-4/12" style="margin-left: -10px !important">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 withdraw-info-icon" icon width="24" height="24">
        <span class="inline-flex items-center justify-center">
          <img src="@/assets/public/svg/icon_public_53.svg" />
        </span>
      </button>
    </div>
    <div class="w-full px-2 d-flex w-8/12" style="
