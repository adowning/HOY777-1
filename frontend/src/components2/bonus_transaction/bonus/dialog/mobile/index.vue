...
<template>
  <div class="m-bonus-dialog-container">
    <div class="flex flex-wrap -mx-2 mx-4 mt-6 text-700-12 text-gray justify-center">
      {{ t("bonus.dialog.title_text") }}
    </div>
    <div class="flex flex-wrap -mx-2 mx-4 mt-6 text-700-12 text-gray">
      <p class="text-center">
        {{ t("bonus.dialog.content_text_1") }}
      </p>
    </div>
    <div class="flex flex-wrap -mx-2 mx-10 mt-10 text-700-14">
      <div class="m-bonus-confirm-btn">
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none" height="40" width="88" click="submitCancel" loading="loading">
          {{ t("bonus.dialog.determine_btn_text") }}
        </button>
      </div>
      <div class="m-bonus-cancel-btn ml-auto">
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none" height="40" width="88" click="emit('bonusDialogHide')">
