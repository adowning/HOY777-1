...
<template>
  <div class="bonus-dialog-container">
    <div class="flex flex-wrap -mx-2 mx-10 mt-6 text-700-16 text-gray">
      {{ t("bonus.dialog.title_text") }}
    </div>
    <div class="flex flex-wrap -mx-2 mx-10 mt-10 text-700-16 text-gray">
      <p>
        {{ t("bonus.dialog.content_text_1") }}
      </p>
    </div>
    <div class="flex flex-wrap -mx-2 mx-10 mt-10 text-700-14 justify-end">
      <div class="bonus-confirm-btn">
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none" width="-webkit-fill-available" height="40px" click="submitCancel" loading="loading">
          {{ t("bonus.dialog.determine_btn_text") }}
        </button>
      </div>
      <div class="bonus-cancel-btn ml-2">
        <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 button-bright text-none" width="-webkit-fill-available" height="40px" click="emit('bonusDialogHide')">
