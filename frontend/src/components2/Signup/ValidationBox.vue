...
<template>
  <div
    class="pa-2 animate glow delay-1 fade-in validation-box-container"
  >
    <div
      v-if="title.length"
      class="flex justify-center ma-2"
    >
      <img
    ...
    <div class="validation-list ma-0 pa-0">
      ...
      >
        <img class="mr-2 validation-item-icon" :src="validationList[n - 1] ? '@/assets/public/svg/icon_public_18.svg' : '@/assets/public/svg/icon_public_17.svg'" />
