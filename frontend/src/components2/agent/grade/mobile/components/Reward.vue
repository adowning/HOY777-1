...
<template>
  <div class="bg-white shadow-lg rounded-lg overflow-hidden m-achievement-reward-card mx-2">
    ...
    <div class="flex flex-wrap -mx-2 mx-3 mt-6">
      <template v-for="(item, index) in achievementItem.award_explain" :key="index">
        <div class="w-full px-2 px-0 w-3/12">
    ...
    <div class="m-achievement-reward-progress-bg mx-3 mb-2">
      <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden m-achievement-reward-progress" v-model="achievementItem.rate" height="24">
      </div>
      <div class="flex flex-wrap -mx-2 m-achievement-progress-grade">
        <template v-for="(item, index) in achievementItem.award_explain" :key="index">
          <div class="w-full px-2 ma-0 pa-0 w-3/12">
