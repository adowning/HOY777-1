...
<template>
  <div class="m-depositinfo-dialog-container">
    <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-close-button" icon="true" click="closeDepositInfoDialog" width="30" height="30">
    ...
    <div class="m-deposit-channel-info mx-5 mt-5">
      ...
      <div class="mt-1">
        <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer px-5">
          <v-list-item-title class="text-left text-500-12 white">
            {{ codeUrl }}
          </v-list-item-title>
          <template v-slot:append>
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-deposit-url-copy-btn ml-2" icon bg-color="#23262F" width="24" height="24" click="handleCopyUrlCode">
    ...
    <div class="mt-10 mx-6">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-deposit-btn m-deposit-btn-ready" width="-webkit-fill-available" height="48px" onclick="handleCopyUrlCode">
