    ...
    <div class="header d-flex align-center relative">
      ...
      >
        <template v-slot:activator="{ props }">
          <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 deposit-header-btn" v-bind="props" click="handlePersonalInfoToggle">
            ...
            <span class="inline-flex items-center justify-center header-mdi-icon" v-if="!pixInfoMenuShow">mdi-chevron-right</v-icon
            >
            <span class="inline-flex items-center justify-center header-mdi-icon" v-else>mdi-chevron-down</span>
          </button>
        </template>
        <ul class="bg-white rounded-md p-2 shadow px-2" theme="dark" bg-color="#1D2027" width="471">
          ...
          <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 isPersonalBtnReady ? 'personal-btn-ready' : ''" width="-webkit-fill-available" height="50px" onclick="handlePixInfoSubmit">
      ...
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 close-button" icon="true" click="cashDialogShow">
        <span class="inline-flex items-center justify-center"> mdi-close </span>
      </button>
    </div>
    <!-- <Notification
