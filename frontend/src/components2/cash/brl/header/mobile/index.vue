    ...
    >
      ...
      >
        <template v-slot:activator="{ props }">
          <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-deposit-header-btn" v-bind="props" click="handlePersonalInfoToggle">
            ...
            <!-- <span class="inline-flex items-center justify-center header-mdi-icon">mdi-chevron-right</span> -->
            <img
        ...
        <ul class="bg-white rounded-md p-2 shadow px-2" theme="dark" bg-color="#1D2027" width mobileWidth> 600 ? 471 : mobileWidth"
        >
          ...
          <li class="flex items-center px-4 py-2 text-gray-800 rounded-md hover:bg-gray-100 transition-colors duration-150 cursor-pointer text-center">
            <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 isPersonalBtnReady ? 'personal-btn-ready' : ''" height="48px" onclick="handlePixInfoSubmit">
      ...
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 m-deposit-close-button" icon="true" click="cashDialogShow" width="40" height="40">
