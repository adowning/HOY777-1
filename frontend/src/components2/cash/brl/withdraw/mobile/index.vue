...
import ValidationBox from '@/components/cash/brl/withdraw/ValidationBox.vue';
...
" value="currencyItem.name" v-for="(currencyItem, currencyIndex) in currencyList" key="currencyIndex" click="handleSelectCurrency(currencyItem)">
      ...
      <ul class="bg-white rounded-md p-2 shadow" theme="dark" bg-color="#15161C">
        <div class="flex flex-wrap -mx-2 m-payment-width-370 px-1">
          <div class="w-full px-2 pa-1 w-6/12" v-for="(paymentItem, paymentIndex) in paymentList" key="paymentIndex">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden text-center" color="#1D2027" theme="dark">
    ...
    <div class="flex flex-wrap -mx-2 mt-6 mx-6 text-500-10 white">
      {{ t("withdraw_dialog.withdraw_amount") }}{{ availableAmount }}
    </div>
    <div class="flex flex-wrap -mx-2 mt-4 mx-2 relative">
      <v-text-field
    ...
    <div class="flex flex-wrap -mx-2 mt-4 mx-6 text-400-10 gray">
    ...
    <div class="flex flex-wrap -mx-2 m-deposit-footer-text-position text-600-10 white justify-center mx-2 mt-10">
    ...
    <div class="m-deposit-btn-position">
      <button class="inline-flex items-center justify-center font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 isDepositBtnReady ? 'm-deposit-btn-ready' : ''" width="-webkit-fill-available" height="48px" loading="loading" onclick="handleWithdrawSubmit">
