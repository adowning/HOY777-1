...
import { type GetCurrencyItem, type GetPaymentItem } from '@/interface/deposit';
...
<template>
  ...
  <div class="deposit-container">
    <div class="flex mt-6 ml-16 deposit-text">
      {{ t("deposit_dialog.deposit_currency") }}
    </div>
    <div offset="4" class="mt-1">
      ...
      <div theme="dark" bg-color="#1D2027" class="px-2">
        <div
        ...
        >
          ...
          <div-title class="ml-2">{{ currencyItem.name }}</div-title>
        </div>
      </div>
    </div>
    <div class="flex mt-6 ml-16 deposit-text">
    ...
    <div offset="4" class="mt-1">
      ...
      <div theme="dark" bg-color="#181522">
        <div class="flex payment-width-370">
          <div 
            cols="6"
            v-for="(paymentItem, paymentIndex) in paymentList"
            :key="paymentIndex"
            class="pa-1 flex flex-col"
          >
            <div color="#15161C" theme="dark" class="deposit-card-height text-center">
              <div
              ...
              >
                ...
                <div-title>{{ paymentItem.name }}</div-title>
                <div-title>{{ paymentItem.description }}</div-title>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="flex mt-2 mx-10" style="width: 400px">
 ...
 : 'deposit-amout-btn-white',
    ...
    <div class="flex mt-0 mx-10 align-center">
    ...
    <div class="flex mt-16 deposit-other-text justify-center">
      {{ t("deposit_dialog.other_text") }}
    </div>
    <div class="flex mt-2 mx-8">
