...
import type {
  ...
  GetPlayersData,
  GetPlayersResponses,
  DeletePlayersByIdData,
  DeletePlayersByIdResponses,
  DeletePlayersByIdErrors,
  GetPlayersByIdData,
  GetPlayersByIdResponses,
  GetPlayersByIdErrors,
  PatchPlayersByIdData,
  PatchPlayersByIdResponses,
  PatchPlayersByIdErrors,
  GetPlayersByIdCheckData,
  GetPlayersByIdCheckResponses,
  GetPlayersByIdCheckErrors,
  PostPlayersByIdVerifyEmailData,
  PostPlayersByIdVerifyEmailResponses,
  GetPlayersByIdInfoData,
  GetPlayersByIdInfoResponses,
  GetPlayersByIdInfoErrors,
  GetPlayersByIdVipinfoData,
  GetPlayersByIdVipinfoResponses,
  GetPlayerAmountData,
  GetPlayerAmountResponses,
  PostPlayerChangeData,
  PostPlayerChangeResponses,
  PostPlayerEmailData,
  PostPlayerEmailResponses,
  PostPlayerPasswordData,
  PostPlayerPasswordResponses,
  PostPlayerSuspendData,
  PostPlayerSuspendResponses,
...
export const getPlayers = <ThrowOnError extends boolean = true>(
  options?: Options<GetPlayersData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    GetPlayersResponses,
    unknown,
...
export const deletePlayersById = <ThrowOnError extends boolean = true>(
  options: Options<DeletePlayersByIdData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).delete<
    DeletePlayersByIdResponses,
    DeletePlayersByIdErrors,
...
export const getPlayersById = <ThrowOnError extends boolean = true>(
...
export const patchPlayersById = <ThrowOnError extends boolean = true>(
  options: Options<PatchPlayersByIdData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).patch<
    PatchPlayersByIdResponses,
    PatchPlayersByIdErrors,
 ...
 */
export const getPlayersByIdCheck = <ThrowOnError extends boolean = true>(
  options: Options<GetPlayersByIdCheckData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    GetPlayersByIdCheckResponses,
    GetPlayersByIdCheckErrors,
 ...
 * Send email verification
 */
export const postPlayersByIdVerifyEmail = <ThrowOnError extends boolean = true>(
  options: Options<PostPlayersByIdVerifyEmailData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PostPlayersByIdVerifyEmailResponses,
    unknown,
 ...
 * Get player info
 */
export const getPlayersByIdInfo = <ThrowOnError extends boolean = true>(
  options: Options<GetPlayersByIdInfoData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    GetPlayersByIdInfoResponses,
    GetPlayersByIdInfoErrors,
 ...
 * Get player VIP info
 */
export const getPlayersByIdVipinfo = <ThrowOnError extends boolean = true>(
  options: Options<GetPlayersByIdVipinfoData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    GetPlayersByIdVipinfoResponses,
    unknown,
...
export const getPlayerAmount = <ThrowOnError extends boolean = true>(
  options?: Options<GetPlayerAmountData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    GetPlayerAmountResponses,
    unknown,
...
export const postPlayerChange = <ThrowOnError extends boolean = true>(
  options: Options<PostPlayerChangeData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PostPlayerChangeResponses,
    unknown,
...
export const postPlayerEmail = <ThrowOnError extends boolean = true>(
  options: Options<PostPlayerEmailData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PostPlayerEmailResponses,
    unknown,
...
export const postPlayerPassword = <ThrowOnError extends boolean = true>(
  options: Options<PostPlayerPasswordData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PostPlayerPasswordResponses,
    unknown,
...
export const postPlayerSuspend = <ThrowOnError extends boolean = true>(
  options: Options<PostPlayerSuspendData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PostPlayerSuspendResponses,
    unknown,
