...
CREATE TABLE "rtg_settings_responses" (
	...
	"user_can_gamble" boolean,
	"user_country" text,
	"user_casino" text,
	"user_currency_code" text,
	"user_currency_symbol" text,
	"user_server_time" timestamp,
	"user_balance_cash" numeric,
	"user_balance_free_bets" numeric,
	"user_balance_bonus" numeric,
	"user_stakes_default_index" integer,
	"user_stakes_last_index" integer,
	"game_cols" integer,
	"game_rows" integer,
	"game_pays_type" text,
	"game_version" text,
	"game_volatility_index" text,
	"game_rtp_default" numeric,
	"game_has_gamble" boolean,
	"game_has_feature_buy" boolean,
	...
	"game_tiles" json,
	"game_features" json,
	"game_multiplier_sequence" json,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "rtg_settings_responses_game_name_unique" UNIQUE("game_name")
);
...
CREATE TABLE "rtg_spin_results" (
	...
	"can_gamble" boolean,
	"token" text,
	"session_net_position" numeric,
	"server_time" timestamp,
	"balance_cash_at_start" numeric,
	"balance_cash_after_bet" numeric,
	"balance_cash_at_end" numeric,
	"balance_free_bets_at_start" numeric,
	"balance_free_bets_after_bet" numeric,
	"balance_free_bets_at_end" numeric,
	"balance_bonus_at_start" numeric,
	"balance_bonus_after_bet" numeric,
	"balance_bonus_at_end" numeric,
	"limits_bet_threshold_time" integer,
	"bonuses" json,
	"tournaments" json,
	"vouchers" json,
	"messages" json,
	...
	"multiplier" numeric,
	"win_total" numeric,
	"wins_multipliers_total" numeric,
	"wins_multipliers_lines" numeric,
	"spin_mode" text,
	"has_state" boolean,
	"win_lines" json,
	"fat_tiles" json,
...
--> statement-breakpoint
ALTER TABLE "rtg_settings_responses" ADD CONSTRAINT "rtg_settings_responses_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rtg_spin_results" ADD CONSTRAINT "rtg_spin_results_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "wallet_cashtag_idx" ON "wallets" USING btree ("cashtag");