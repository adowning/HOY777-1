<template>
  <li
    class="flex-shrink-0 h-[70px] w-[280px] rounded-xl p-0.5 mx-6 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(236,72,153,0.5)]"
  >
    <div
    ...
    >
      <div class="relative flex-shrink-0">
        <img
          ...
          class="w-20 h-20 max-h-[70px] p-1 rounded-lg object-cover border-2 border-slate-700"
      ...
      >
        <div
          class="text-base font-bold text-slate-50 leading-1"
          style="line-height: 1"
        >
          {{ winner.name }} <span class="font-normal">won</span>
        </div>
        <div
          class="flex items-center gap-1 text-lg font-bold text-yellow-400 mb-4 leading-1"
          style="line-height: 1"
        >
          <!-- Coin Icon -->
          <svg
