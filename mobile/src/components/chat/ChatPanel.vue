<template>
  <div id="morph-container" ref="morphContainer" @click="openChat">
    <div id="neon-box" ref="neonBox" class="text-white border-white zIndex-1">
      ...
      <VGSprite
        id="logoShine"
        class="flex"
        image-src="/images/bottom/logo_shine_trans.png"
        :sprite-sheet-data="LogoJson"
        style="position: absolute; transform: scale(0.9); z-index: -1"
        :speed="60"
        :delay="6000"
        :offset="5000"
        :autoplay="true"
