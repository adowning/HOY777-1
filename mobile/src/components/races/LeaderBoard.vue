      ...
      >
        ...
        >
            ...
            <div class="flex-1 flex justify-end">
              ...
              >
                <img
                  :src="`${
                    closePressed
                      ? '/images/common/close-pressed.png'
          ...
          <div class="w-full flex justify-center" style="">
            <div
              v-if="list[2]"
              class="flex"
              :style="`background-image: url('/images/avatars/${list[2].image}'); background-repeat: no-repeat;
        ...
        background-position-x: 10px;
          ...
          <div class="scroll-wrapper relative">
            ...
            >
              <div
                ...
                ref="productbar"
                :key="user.id"
                class="product my-1 justify-start pl-2 pt-0 w-full align-baseline inline-block"
          ...
          background-size:  100% 100%; background-position-y: center;background-position-x: start;`"
              >
                <div
                  class="align-middle inline-block flex-row justify-start gap-1 pr-1"
                  style="min-width: 90%; line-height: 1.5; text-align: middle"
                >
                  <div class="justify-start inline-block align-middle">
                    <div
                      style="
                  ...
                  <div
                    class="not-glow grow justify-start pt-2 align-baseline inline-block"
                  >
                    {{ user.username.substring(0, 12) }}
                  </div>
                  <div
                    class="flex-row w-full justify-end mr-1 ml-5 py-3 grow inline-block align-middle"
                  >
                    <img
...
.glow {
  ...
  text-shadow: 2px 2px 10px #c74dff, 0 0 20px #c74dff, 0 0 30px #720fc4;
}
