    ...
    <div class="blackjack-tables">
        <div class="tables-header">
            ...
            <div class="header-available">
                ...
                <div v-on:click="blackjackToggleShowAvailable" class="available-toggle"
                    v-bind:class="{ 'toggle-active': blackjackShowAvailable === true }"></div>
            </div>
        ...
        <div class="tables-content">
            <transition name="fade" mode="out-in">
                ...
                <div v-else class="content-list" key="data">
                    ...
                    <BlackjackTablesElement v-for="table of blackjackGetTables.standard" v-bind:key="table.table"
                        v-bind:table="table" />
...
const blackjackShowAvailable = ref(false);
const blackjackStore = useBlackjackStore();
const socketStore = useSocketStore();
const { tables: blackjackTables, connected } = storeToRefs(blackjackStore);

const blackjackToggleShowAvailable = () => { blackjackShowAvailable.value = !blackjackShowAvailable.value; };
