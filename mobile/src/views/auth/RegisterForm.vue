...
const { signInWithPassword, signUpNewUser, signInWithGoogleIdToken } =
  authStore
...
const handleSignUp = async () => {
  ...
  const success = await authStore.signUpNewUser({
  ...
  <MyPanel title="Register" class="relative">
    <div class="flip-card__form flex mx-4 px-4 flex-col mt-5 overflow-hidden">
      <form class="flip-card__form flex grow-1" @submit.prevent="handleSignUp">
        <input v-model="formData.username" type="text" placeholder="Username" required class="flip-card__input"
        ...
        <!-- <input
          ...
          :disabled="isAuthLoading"
        /> -->
        <input v-model="formData.password" type="password" placeholder="Password" required autocomplete="new-password"
          class="flip-card__input" :disabled="isAuthLoading" />
        <input v-model="formData.confirmPassword" type="password" placeholder="Confirm Password" required
          autocomplete="new-password" class="flip-card__input" :disabled="isAuthLoading" />
        <GlassButton type="submit" class="flip-card__btn" :disabled="isAuthLoading" :loading="isAuthLoading"
          @click="handleSignUp">
          Confirm!
        </GlassButton>
      </form>
