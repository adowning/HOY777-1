<template>
  <div class="login-view-container overflow-hidden">
    ...
    <div class="flex justify-center items-center min-h-[20px] w-80 glow text-sm">
      ...
      <input type="checkbox" id="switch" style="transform: scale(0.5)" @click="appBarStore.toggleSignUpMode" /><label
...
const { signInWithPassword, signUpNewUser, } = authStore;
...
onMounted(() => {
  ...
  appBarStore.setSignUpMode(false);
