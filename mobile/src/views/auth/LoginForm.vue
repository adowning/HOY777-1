...
<template>
  <ShowToasts />
  <MyPanel title="Login">
    <form class="flip-card__form flex mx-4 px-4 mt-5 overflow-hidden" @submit.prevent="handleSignIn">
      ...
      <input v-model="formData.password" type="password" placeholder="Password" required autocomplete="current-password"
        class="flip-card__input" :disabled="isAuthLoading || showError" />
    ...
    <div class="flex flex-col">
      ...
      <div id="googleSignInButtonContainer" class="google-signin-container flex mt-2 mx-3 px-3 justify-center"></div>
    </div>
