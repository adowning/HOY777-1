 ...
 */
type TimeFormatter = (time: number | string | undefined) => string;
 ...
 */
declare function createHandler(opts?: DebugLogOptions): (obj: unknown) => void;

/**
 * hono-pino/debug-log transport
 */
declare function export_default(opts?: DebugLogOptions): Promise<stream.Transform & build.OnUnknown>;

export { type BindingsFormatter, type DebugLogOptions, type LevelFormatter, type TimeFormatter, createHandler, export_default as default };
