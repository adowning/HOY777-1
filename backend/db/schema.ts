...
export const vipLevels = pgTable('vip_levels', {
  ...
  availableDailyBonusTime: varchar('available_daily_bonus_time', {
    length: 256,
  }),
  collectableWeekBonusDay: varchar('collectable_week_bonus_day', {
    length: 256,
  }),
  collectableMonthBonusDay: varchar('collectable_month_bonus_day', {
    length: 256,
  }),
})
