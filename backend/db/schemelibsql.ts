...
export const users = sqliteTable('users', {
  ...
  emailConfirmed: integer('email_confirmed', { mode: 'boolean' }).default(
    false
  ),
  phoneConfirmed: integer('phone_confirmed', { mode: 'boolean' }).default(
    false
  ),
  ...
  locale: text('locale'),
  initialProfileComplete: integer('initial_profile_complete', {
    mode: 'boolean',
  }).default(false),
  isSuspended: integer('is_suspended'),
  sysCommunications: integer('sys_communications', { mode: 'boolean' }).default(
    false
  ),
  lockedPersonalInfoFields: text('locked_personal_info_fields', {
    mode: 'json',
  }),
...
export const promoGroups = sqliteTable('promo_groups', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
export const inviteCommissionHistory = sqliteTable(
