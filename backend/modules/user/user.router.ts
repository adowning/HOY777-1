...
userRoutes.openapi(enterGame, controller.enterGame)
userRoutes.openapi(userGame, controller.userGame)
userRoutes.openapi(favoriteGame, controller.favoriteGame)
userRoutes.openapi(gameHistory, controller.gameHistory)
userRoutes.openapi(spinPage, controller.spinPage)
userRoutes.openapi(spin, controller.spin)
userRoutes.openapi(favoriteGameList, controller.favoriteGameList)
...
// New Routes
userRoutes.openapi(getUserAmount, controller.getUserAmount)
userRoutes.openapi(updateUserInfo, controller.updateUserInfo)
userRoutes.openapi(updateEmail, controller.updateEmail)
userRoutes.openapi(updatePassword, controller.updatePassword)
userRoutes.openapi(suspendUser, controller.suspendUser)
userRoutes.openapi(getBalanceList, controller.getBalanceList)
