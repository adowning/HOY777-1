...
import type {
  ...
  WebSocketBroadcastPayload, WalletUpdatedPayload,
 ...
 */
export const appEventEmitter = new EventEmitter2({
  wildcard: true,
  delimiter: '.',
})
...
export enum AppEvents {
  ...
  VIP_INFO_UPDATED = 'vipInfo.update',
...
export interface EventPayloads {
  ...
  [AppEvents.WALLET_UPDATED]: WalletUpdatedPayload
  ...
  [AppEvents.VIP_INFO_UPDATED]: VipInfoUpdatedPayload
