    ...
    [122, 85], {
        712: function(a, t, s) {
            ...
            function h(a, t, s) {
                ...
                }() ? Reflect.construct(t, s || [], (0, u.default)(a).constructor) : t.apply(a, s))
            }
            var c = s(713),
                f = s(238),
                p = function(a) {
                    ...
                    return (0, n.default)(t, a), (0, l.default)(t, [{
                        ...
                        value: function() {
                            ...
                            var a = "real" === this._urlParams.playMode,
                                s = {
                ...
                p = function(a) {
                    ...
                    return (0, n.default)(t, a), (0, l.default)(t, [{
                        ...
                        value: function() {
                            ...
                            var a = {
                                freeBets: !1,
                                history: "real" === this._urlParams.playMode,
                                roundId: !1,
                                fullScreen: !0,
                                lobby: !1,
                                delegateMessages: !1,
                            ...
                            "true" === this._urlParams.hasPreloader && (a.hasPreloader = !0), "false" === this._urlParams.hasPreloader && (a.hasPreloader = !1), this._cfg.bars.options = f(this._cfg.bars.options, a)
                        }
                    }, {
                        key: "_parseGame",
                        value: function() {
                            (0, o.default)((0, u.default)(t.prototype), "_parseGame", this).call(this), !1 !== this._cfg.game.preconfig.splash && (this._cfg.game.preconfig.splash = "false" !== this._urlParams.splash)
                        }
                    }])
                }(c);
            a.exports = p
