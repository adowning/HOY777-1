(window.webpackJsonp = window.webpackJsonp || []).push([
    [0], {
            ...
            var b = a(60).getURLParams(),
                ...
                w = function() {
                    function e(t, a, n) {
                        ...
                        (0, i.default)(this, e), this._cfg = this._preParse(n), this._operator = a, this._provider = t, this._settings = null, this._abTest = o.abTest, this._urlParams = b, this.name = o.name, this._cfg.bridge && this._cfg.bridge.postParams && "object" === (0, r.default)(this._cfg.bridge.postParams) && Object.keys(this._cfg.bridge.postParams).forEach((function(e) {
                    ...
                    return (0, o.default)(e, [{
                        key: "parse",
                        value: function() {
                            this._isRTG = "com.casino.game" === this._cfg.game.namespace, this._isCayetano = "com.cayetano.game" === this._cfg.game.namespace, this._isNSG = "com.nsg.game" === this._cfg.game.namespace, this._isNetent = "com.netent.game" === this._cfg.game.namespace, this._isDemo = this._cfg.server.launchParams && "demo" === this._cfg.server.launchParams.playMode, this._isSlot = "slot" === this._cfg.game.preconfig.gameType, this._isTap = "tap" === this._cfg.game.preconfig.gameType, this._isTouch = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent), this._isIOS10 = document.querySelector("html").classList.contains("ios10"), this._brand = this._cfg.server.launchParams.custom && this._cfg.server.launchParams.custom.siteId, this._parse()
                        }
                    }, {
                        key: "get",
                        value: function(e) {
                        ...
                        value: function() {
                            if (this._settings && this._settings.user.country) {
                                ...
                                var a = (0, d.default)("customLang", this._operator, this._brand),
                                    n = a.customLanguage,
                                    s = a.target;
                                n && s ? this._setRegulations([{
                            ...
                            f.default.includes(this._brand) && this._setRegulations(e.brRegulation), "evolution" !== this._provider && e.deRegulation.push({
                                name: e.regulationTypes.REGULATION_RTP
                            });
                            var r = (0, d.default)("defaultStakeBrands");
                            null != r && r.includes(this._brand) && (this._setRegulations(e.nlRegulation), console.log("Netherlands Regulations are activated for brand: ".concat(this._brand)))
                        }
                    }, {
                        key: "_parseBundle",
                        value: function() {
                        ...
                        value: function(t) {
                            switch (t.name) {
                                ...
                                case e.regulationTypes.MAX_WIN_PROBABILITY:
                                    "evolution" !== this._provider && (this._cfg.bars.options.maxWinProbability = !0);
                                    break;
                                ...
                                case e.regulationTypes.MIN_ROUND_DURATION:
                                    var a = t.options.duration,
                                        n = void 0 !== t.options.hasSpinProgress ? t.options.hasSpinProgress : this._isSlot || this._isTap;
                                ...
                                case e.regulationTypes.GAME_SESSION:
                                    "false" !== this._urlParams.toggleGameSession && (this._cfg.bars.options.hasGameSession = !0);
                                    break;
                        ...
                        value: function(e) {
                            ...
                            this._cfg.widgets.enabled = !0, "tournaments-generic" === t && (t = l.default.genericSkinMapping());
                            var a = "".concat(this._cfg.game.preconfig.cdn, "../../widgets/").concat(t, "/");
                            if ("true" === b.inReview || this._cfg.bridge.inReview) {
                                var n = b.tournamentBranch || "dev";
                        ...
                        value: function(e) {
                            ...
                            if ("network" !== t || i || (t = u.default.networkSkinMapping()), this._cfg.jackpotPanel = {
                                    enabled: !1,
                            ...
                            var o = "true" === b.inReview || this._cfg.bridge.inReview;
                            ...
                            if (this._cfg.game.preconfig.skipJackpotWin = n, this._settings && this._settings.jackpots && this._settings.jackpots.jackpotId) {
                                ...
                                if (o) {
                                    var d = b.jackpotBranch || "dev",
                                        f = b.jackpotWheelBranch || "dev",
                                        h = b.jackpotPack;
                        ...
                        value: function(e) {
                            var t, a, n, s = this._settings || {},
                                ...
                                d = e.rtp,
                                f = e.isStateful,
                                h = !1 !== c.options.hasRtp && 0 !== d,
                                b = s.game && s.game.gameType,
                                _ = s.game && ("slot" === b || "scratch" === b) && !1 !== c.hasMaxMultiplierText && s.game.maxMultiplier,
                                y = s.game && s.game.pendingRoundDays,
                                v = c.options.hasVersions,
                                T = c.options.hasFeatureBuyVersion,
                                k = c.options.hasGameSession,
                                P = c.help && c.help.jackpots && !0 === c.help.jackpots.hasDynamicTimeJackpot,
                                O = c.help && c.help.jackpots && c.help.jackpots.dynamicTimeJackpotValue,
                                R = s.jackpots && !0 === s.jackpots.dynamicAllocation,
                                I = R && s.jackpots.stakeCaps,
                                A = c.options.hasPayoutExampleTextNoMultiline || !1,
                                ...
                                E = c.options.hasFeatureBuy,
                                w = c.options.hasAdditionalExplanation,
                                N = c.options.hasVolatilityIndex && s.game && s.game.volatilityIndex;
                            ...
                            var U = s.user && s.user.stakes && s.user.stakes.types;
                            ...
                            var j = i && void 0 !== i.hasAutoplaySettings ? e.hasAutoplaySettings : !c.options.autoPlayFields || c.options.autoPlayFields && c.options.autoPlayFields.singleWinLimit || c.options.autoPlayFields && c.options.autoPlayFields.stopOnJackpot || c.options.autoPlayFields && c.options.autoPlayFields.stopOnBonus,
                                C = {
        ...
        877: function(e, t, a) {
            ...
            t.default = function(e, t) {
                if (e) {
                    var a = r.default.find((function(t) {
                            return t.operators.hasOwnProperty(e)
                        })) || {},
                        n = a.config,
                        s = a.operators;
                    return n && s ? s[e].includes(t) ? o(o({}, n), {}, {
                        target: t
                    }) : s.hasOwnProperty(e) && 0 === s[e].length ? o(o({}, n), {}, {
                        target: e
                    }) : n : (console.warn("[bridge] #customLangMapping: Provided operator: ".concat(e, " or brand: ").concat(t || "unknown", " doesn`t exists in the custom lang mapping, so the custom lang regulation will not be activated... Activating RegulationsFactory ")), {})
                }
            }
        },
        878: function(e, t, a) {
        ...
        885: function(e, t, a) {
            ...
            var u = function() {
                return (0, i.default)((function e() {
                    ...
                    key: "parse",
                    value: function(e, t, a) {
                        var n = !(a.isDemo || a.isScratch || a.isNsg || a.isTap || a.isRTG && a.isTable || "evolution" === e.bridge.provider);
                    ...
                    return (0, r.default)(e, null, [{
                        ...
                        value: function(t, a, n) {
                            var s = e.CDN_MAP[n.urlParams.environment || "production"],
                                ...
                                i = "".concat(s, "games/localizations/"),
                                c = t.jackpotPanel,
                                u = t.jackpotWheel,
                                l = t.gamble,
                                p = t.bonus,
                                g = t.widgets,
                                d = "stars" === t.bridge.provider ? "".concat(t.bridge.cdn, "gameloader") : "".concat(t.bridge.cdn, "core"),
                                f = this.bundlerGameId ? "".concat(t.bridge.cdn, "games.").concat(this.bundlerGameId) : "".concat(t.bridge.cdn, "games.").concat(t.server.launchParams.gameId),
                                h = this.bundlerGameId ? this.bundlerGameId : t.server.launchParams.gameId,
                                m = t.server.launchParams.userData.lang;
                            ...
                            var b = com.casino && com.casino.bundler || {},
                                _ = b.isBundlerV2Build,
                                y = b.assetsCDN;
                            if (m && e.langsMapping.hasOwnProperty(m) && (m = e.langsMapping[m]), t.bars.basePath = _ ? "".concat(y, "/games.bars-next/") : n.urlParams.barsURL || "".concat(d, "/games.bars-next/"), this.isBarsMapped = o.default.some((function(e) {
                                ...
                                var v = this.omnibarPath || "".concat(d, "/games.omnibar/");
                            ...
                            if (t.widgets) {
                                ...
                                var T = t.widgets.tournaments;
                                if (T) {
                                    var k = T.base.match(/widgets\/(.+)\//);
                                    k && k[1] && (T.base = "".concat(d, "/games.widgets.").concat(k[1], "/"))
                                }
                            }
                            if (u) {
                                var P = !n.isCayetano && !u.wheelWinOnly ? u.skin : "base-wheel";
        ...
        902: function(e, t, a) {
            ...
            var E = b("v5", 80, (function(e) {
                    ...
                    for (var p = 0; p < i; ++p) {
                        ...
                        for (var f = 16; f < 80; ++f) g[f] = S(g[f - 3] ^ g[f - 8] ^ g[f - 14] ^ g[f - 16], 1);
                        for (var h = a[0], m = a[1], b = a[2], _ = a[3], y = a[4], v = 0; v < 80; ++v) {
                            var T = Math.floor(v / 20),
                                k = S(h, 5) + A(T, m, b, _) + y + t[T] + g[v] >>> 0;
